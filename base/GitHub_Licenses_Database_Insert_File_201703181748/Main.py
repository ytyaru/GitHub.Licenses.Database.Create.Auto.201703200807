...
import os.path
import subprocess
import base.GitHub_Licenses_Database_Insert_File_201703181748.Data
import base.GitHub_Licenses_Database_Insert_File_201703181748.command.miscellaneous.Licenses
class Main:
    def __init__(self, user_name, path_db_account, path_db_repo, path_db_license):
        self.data = base.GitHub_Licenses_Database_Insert_File_201703181748.Data.Data(user_name, path_db_account, path_db_repo, path_db_license)
        self.licenses = base.GitHub_Licenses_Database_Insert_File_201703181748.command.miscellaneous.Licenses.Licenses(self.data)
