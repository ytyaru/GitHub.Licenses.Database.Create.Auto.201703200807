...
import base.GitHub_Licenses_Database_Insert_File_201703181748.command.miscellaneous.Pagenation

class Licenses:
    def __init__(self, data):
        self.data = data
        self.page = base.GitHub_Licenses_Database_Insert_File_201703181748.command.miscellaneous.Pagenation.Pagenation()
